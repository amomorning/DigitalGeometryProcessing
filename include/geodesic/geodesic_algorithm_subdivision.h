...
protected:
		//list all nodes that belong to this mesh element
	...
	//list only the nodes whose current distance is larger than the threshold
	void list_nodes_visible_from_node(node_pointer node,			
									  std::vector<node_pointer>& storage,
